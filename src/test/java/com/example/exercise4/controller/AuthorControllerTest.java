...
import com.example.exercise4.exception.AuthorNotFoundException;
...
import com.example.exercise4.service.AuthorService;
...
public class AuthorControllerTest {
  ...
  void save_and_return_author_details_with_http_200() throws Exception {
    ...
    this.mockMvc.perform(post("/authors").with(SecurityMockMvcRequestPostProcessors.user("dummy1"))
            .content(
  ...
  void save_and_return_book_details_with_http_200() throws Exception {
    ...
    this.mockMvc.perform(post("/authors/1/books").content(
        ...
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.description").value(expectedBook.getDescription()))
        .andExpect(
            MockMvcResultMatchers.jsonPath("$.author.id").value(expectedBook.getAuthor().getId()))
    ;
